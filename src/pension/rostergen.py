...
SPECIAL_NOTES: Final[tuple[tuple[str, str], ...]] = (
    ...
    ("사례 08", "프로즌 DC 전환자 — 과거 근속분은 퇴직금(DB)으로 남고 이후분만 DC."),
    ("사례 09", "임원 퇴직소득 세법한도 프로즌 — 2019년 이전 3배수·이후 2배수로 "
              "지급구간이 갈린다."),
    ...
    ("사례 18", "2026-03-31 분기말 전환평가(First 재평가) 셋팅 — 사업연도말은 12월."),
    ("사례 19", "DC 전환 후 퇴직자 — 재직자·퇴직자명부에 사번이 중복된다. "
              "DC 전환 예정자·퇴직 예정자의 산출 방법도 정해야 한다."),
    ("사례 20", "현장(전장)직원은 정년퇴직 시 기본급을 추가로 지급한다."),
