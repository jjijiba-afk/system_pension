...
원본 통합문서의 VBA 주석은 ``지급률``, ``지급률(사망)``, ``지급률(정년)`` 같은
...
class CauseBenefit:
    ...
    자료요청서 6번에도 세 줄이 따로 있다.
        ...
        사망시 퇴직금 지급률       동일, 유족지원금 5,000만원
        정년퇴직시 퇴직금 지급률   대표이사 3배, 이사/감사 1.5배
...
'20년 이상 근속 퇴직자에게 순금 8돈' 처럼, 재직 중에는 주지 않고 퇴직할 때
