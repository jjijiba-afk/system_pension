...
ACTIVE = [
    ...
    ("필수", "사번", "회사 사번. 전기와 맞대어 볼 때 이것으로 짝지웁니다",
     "A0001", "성별+생년월일+성명으로 임시 사번을 만듭니다"),
    ("필수", "성명", "동명이인이 있어도 그대로", "홍길동", "사번만으로 봅니다"),
    ("필수", "성별", "남 / 여 (M/F, 1/2 도 읽습니다)", "남", "사망률을 못 정합니다"),
    ("필수", "생년월일", "YYYY-MM-DD", "1985-05-01", "연령을 못 정해 산출 제외"),
    ("필수", "입사일자", "근속 기산일. 중간정산자는 중간정산일이 우선합니다",
     "2010-03-02", "근속을 못 정해 산출 제외"),
    ("필수", "직군", "지급률·정년이 갈리는 묶음. [기본정보] 시트의 직군 규칙과 맞춥니다",
     "정규직", "첫 직군으로 봅니다"),
    ("필수", "임직원구분", "직원 / 임원", "직원", "직원으로 봅니다"),
    ("필수", "30일 평균임금", "근로기준법상 평균임금 30일분(원)", 5_000_000,
     "임금이 0이라 채무도 0"),

    ("제도·근속", "퇴직급여 제도구분", "DB / DC / 퇴직금제도. DC 는 산출에서 빠집니다",
     "DB", "DB 로 봅니다"),
    ("제도·근속", "중간정산일", "중간정산을 했으면 그 날. 근속이 이 날부터 다시 셉니다",
     "", "중간정산 없음"),
    ("제도·근속", "중간정산 지급금액", "중간정산으로 이미 지급한 금액(원)", "", "0"),
    ("제도·근속", "가산 근속연수", "군경력 등으로 더해 주는 연수", "", "0"),
    ("제도·근속", "차감 근속연수", "휴직 등으로 빼는 연수. 양수로 적으세요", "", "0"),
    ("제도·근속", "회사 추계액", "회사가 계산해 둔 퇴직급여추계액(원). 검산용으로만 씁니다",
     "", "검산을 건너뜁니다"),
    ...
    ("개인 예외", "개인 지급배수", "규정 대신 이 사람의 배수를 직접 넣을 때", "",
     "지급률 규정을 씁니다"),
    ("개인 예외", "가산(감소) 지급률", "정률로 더하거나 빼는 지급률", "", "0"),
    ("개인 예외", "지급률 규정", "이 사람에게만 다른 지급률을 걸 때 그 규정명",
     "", "직군에 걸린 규정"),
...
RETIRED = [
    ("필수", "순번", "1부터 이어지는 번호", 1, "무시합니다"),
    ("필수", "사번", "회사 사번", "T0001", "성별+생년월일+성명으로 임시 사번"),
    ("필수", "성명", "", "이퇴직", "사번만으로 봅니다"),
    ("필수", "성별", "남 / 여", "남", "사망률 통계에서 빠집니다"),
    ("필수", "생년월일", "YYYY-MM-DD", "1980-02-10", "연령을 못 정합니다"),
...
SECOND_ACTIVE = {
    "순번": 2, "사번": "A0002", "성명": "김임원", "성별": "여",
    "생년월일": "1972-08-15", "입사일자": "2005-01-02", "직군": "임원",
    "임직원구분": "임원", "30일 평균임금": 9_000_000,
    "퇴직급여 제도구분": "DB", "원가코드": "판관비", "장기급여 대상": "N",
}
SECOND_RETIRED = {
    "순번": 2, "사번": "T0002", "성명": "박정년", "성별": "여",
    "생년월일": "1965-11-20", "입사일자": "1998-03-02", "퇴사일": "2025-11-20",
    "퇴직사유": "정년", "직군": "정규직", "임직원구분": "직원",
